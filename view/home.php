        ...
        <div class="main-content">
            <div class="product-container margin-top">
                <div class="border-under">
                    <h1><i class="fas fa-font-awesome"></i> Sản phẩm mới nhất</h1>
                </div>
                    ...
                    foreach ($products as $product) {
                        ...
                        echo ' 
                            ...
                            <div class="product-info">
                                ...
                                <p class="voucher">Sử dụng mã <span class="code">COOL10</span> để được giảm 10%</p>
                            </div>
                            </div>
                            ';
                    }
            ...
            <div class="product-container ">
                <div class="border-under">
                    <h1><i class="fas fa-heart"></i> Top 8 yêu thích</h1>
                </div>
                <div class="product-row">
                    <?php
