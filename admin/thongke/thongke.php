...
// Tạo mảng để lưu trữ số lượt truy cập cố định cho mỗi tháng
$monthly_visits = array_fill(1, 12, 0);
$monthly_visits[4] = 135;  // Tháng 4: 1000 lượt xem
$monthly_visits[5] = 97;  // Tháng 5: 2000 lượt xem
...
<body>
    ...
    <table>
        ...
        <?php
            // Hiển thị dữ liệu lượt truy cập cố định
            echo "<tr>
                <td>Tháng 4</td>
                <td>{$monthly_visits[4]}</td>
                </tr>";
            echo "<tr>
                <td>Tháng 5</td>
                <td>{$monthly_visits[5]}</td>
                </tr>";
                if (isset($_SESSION['visits'])) {
                    foreach ($_SESSION['visits'] as $date => $visits) {
                        echo "<tr>
